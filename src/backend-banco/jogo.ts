...
namespace ControllerContasPagar {
    ...
    export const ContasPagarBaseSchema = z4.object({
        ...
        tipo: z4.string(),
        valor: z4.number(),
        data: z4.string(),  // Se preferir transformar em Date, use z4.date()
        categoria: z4.string(),
        ...
        export const InputSchema = z4.object({
            filtros: z4.object({
                contasPagar: z4.object({
                    ...
                    data: z4.string().optional().nullable(),  // Se preferir transformar em Date, use z4.date().optional().nullable()
        ...
        export const InputSchema = z4.object({
            data: z4.object({
                contasPagar: z4.object({
                    ...
                    data: z4.string().optional(),  // Se preferir transformar em Date, use z4.date().optional()
