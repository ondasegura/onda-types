...
namespace Response {
    ...
    export const validateSuccessParams = (data: unknown) => SuccessParamsSchema.parse(data);

    export const validateCreatedParams = (data: unknown) => CreatedParamsSchema.parse(data);

    export const validateWarningParams = (data: unknown) => WarningParamsSchema.parse(data);

    export const validateErrorWarningParams = (data: unknown) => ErrorWarningParamsSchema.parse(data);

    export const validateErrorParams = (data: unknown) => ErrorParamsSchema.parse(data);

    export const validateServerErrorParams = (data: unknown) => ServerErrorParamsSchema.parse(data);

    export const validateFileResponseParams = (data: unknown) => FileResponseParamsSchema.parse(data);

    export const validateNotFoundOrUnauthorizedParams = (data: unknown) => NotFoundOrUnauthorizedParamsSchema.parse(data);

    export const validateBaseResponse = (data: unknown) => BaseResponseSchema.parse(data);
}
